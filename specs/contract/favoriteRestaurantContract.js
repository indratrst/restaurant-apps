...
//   it(
//     `should refuse a restaurant from being added
//      if it does not have the correct property`,
//     async () => {
...
//   it(
//     `should handle request to remove a restaurant 
//   even though the restaurant has not been added`,
//     async () => {
//       favoriteRestaurant.putRestaurant({ id: 1 });
//       favoriteRestaurant.putRestaurant({ id: 2 });
//       favoriteRestaurant.putRestaurant({ id: 3 });
